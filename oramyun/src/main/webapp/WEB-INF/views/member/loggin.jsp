   ...
   <div class="member_wrapper">
      ...
      <form action="${pageContext.request.contextPath}/member/insertPro" id="join-form" class="join_form" name="fr" onsubmit="return checkForm()" method="post">
         <div class="j_f_box">
            ...
            <input type="text" id="member_id" name="member_id" class="id j_f_b_input2" placeholder="6~16자 내로 아이디를 입력해주세요" required="required">
         ...
         <div class="j_f_box">
            ...
            <input type="text" id="name" name="member_name" class="j_f_b_input" placeholder="이름을 입력해주세요" required>
         </div>
         <div class="j_f_box">
            <span class="j_f_b_title">생년월일</span>
            <!-- 출생년도 -->
            <input type="text" id="member_year" name="year" class="j_f_b_input3" placeholder="출생년도(4자리)">
            <!-- 출생월 -->
            ...
            <!-- 출생일 -->
            <input type="text" id="member_day" name="day" class="j_f_b_input3" placeholder="일">
         </div>
         <div class="j_f_box">
         ...
         <div class="j_f_box">
            ...
            <input type="text" id="email1" name="email1" class="j_f_b_email" placeholder="이메일" required>
         ...
         <div class="j_f_box">
            ...
            <input type="text" id="sample4_postcode"  class="j_f_b_input2"  placeholder="우편번호" readonly required>
            <input type="button" onclick="sample4_execDaumPostcode()" class="j_f_b_input2_btn" name = "address1" value="우편번호 찾기" >
            <input type="text" id="sample4_roadAddress" name = "address1" class="j_f_b_input j_f_b_i_space" placeholder="도로명주소" readonly required>
         ...
         <div class="j_f_box">
            ...
            <input type="text" id="mobile" name="member_phone" class="j_f_b_input" placeholder="휴대폰 번호를 입력해주세요" required>
         </div>
